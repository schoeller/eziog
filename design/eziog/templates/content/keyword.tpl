...
<div class="attribute-header">
    <h1 class="long">{'Keyword: %keyword'|i18n( 'design/eziog/content/keyword', ,
hash( '%keyword', $alphabet ) )|wash()}</h1>
</div>

<table class="list" width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>{'Link'|i18n( 'design/eziog/content/keyword' )}</th>
    <th>{'Type'|i18n( 'design/eziog/content/keyword' )}</th>
</tr>
{if $list_count}
