...
<div class="element">
<label>{'Year'|i18n( 'design/eziog/content/datatype' )}:</label>
...
<div class="element">
<label>{'Month'|i18n( 'design/eziog/content/datatype' )}:</label>
...
<div class="element">
<label>{'Day'|i18n( 'design/eziog/content/datatype' )}:</label>
...
<div class="element">
<img class="datepicker-icon" src={"calendar_icon.png"|ezimage} id="{$attribute_base}_date_cal_{$attribute.id}" width="24" height="28" onclick="showDatePicker( '{$attribute_base}', '{$attribute.id}', 'date' );" style="cursor: pointer;" alt="{'Show calendar to select a date.'|i18n( 'design/eziog/content/datatype' )}" />
