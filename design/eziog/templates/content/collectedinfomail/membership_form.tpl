{set-block scope=root variable=subject}{"Membership information from %1 %2"|i18n("design/eziog/collectedinfomail/form",,array($collection.data_map.first_name|wash, $collection.data_map.last_name|wash))}{/set-block}
