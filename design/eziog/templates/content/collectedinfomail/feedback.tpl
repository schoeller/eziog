{set-block scope=root variable=subject}{"Feedback from %1"|i18n("design/eziog/collectedinfomail/feedback",,array($collection.object.name|wash))}{/set-block}
...
{"The following feedback was collected"|i18n("design/eziog/collectedinfomail/feedback")}:
