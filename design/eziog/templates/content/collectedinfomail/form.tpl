{set-block scope=root variable=subject}{"Collected information from %1"|i18n("design/eziog/collectedinfomail/form",,array($collection.object.name|wash))}{/set-block}
