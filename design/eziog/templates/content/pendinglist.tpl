...
<div class="attribute-header">
    <h1 class="long">{'My pending items [%pending_count]'|i18n( 'design/eziog/content/pendinglist',, hash( '%pending_count', $list_count ) )}</h1>
</div>
...
<tr>
    <th>{"Name"|i18n("design/eziog/content/pendinglist")}</th>
    <th>{"Class"|i18n("design/eziog/content/pendinglist")}</th>
    <th>{"Section"|i18n("design/eziog/content/pendinglist")}</th>
    <th>{"Version"|i18n("design/eziog/content/pendinglist")}</th>
    <th>{"Last modified"|i18n("design/eziog/content/pendinglist")}</th>
</tr>
...
<tr class="{$style}">
   <td>
    ...
    <td>
        ...
        {else}
            <i>{'Unknown'|i18n( 'design/eziog/content/pendinglist' )}</i>
        {/if}
    </td>
    <td>
...
<div class="feedback">
    <h2>{"Your pending list is empty"|i18n("design/eziog/content/pendinglist")}</h2>
</div>
