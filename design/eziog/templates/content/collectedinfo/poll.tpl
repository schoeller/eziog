{set-block scope=global variable=title}{'Poll %pollname'|i18n( 'design/eziog/collectedinfo/poll', , hash( '%pollname', $node.name|wash() ) )}{/set-block}
...
<div class="content-view-full">
    ...
    <div class="attribute-header">
        <h1>{'Results'|i18n( 'design/eziog/collectedinfo/poll' )}</h1>
    </div>
        ...
        <div class="warning">
            <h2>{'Please log in to vote on this poll.'|i18n( 'design/eziog/collectedinfo/poll' )}</h2>
        </div>
        {/if}

        {if $error_existing_data}
        <div class="warning">
            <h2>{'You have already voted for this poll.'|i18n( 'design/eziog/collectedinfo/poll' )}</h2>
        </div>
        {/if}
                    ...
                    <td class="poll-resultbar">
                        ...
                        <tr>
                            ...
                            <td class="poll-votecount">
                                {'Votes'|i18n( 'design/eziog/collectedinfo/poll' )}: {$item_count}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
        ...
        {'%count total votes'|i18n( 'design/eziog/collectedinfo/poll' ,,
                                     hash( '%count', fetch( content, collected_info_count, hash( object_id, $object.id ) ) ) )}

            <div class="content-results">
                <div class="attribute-link">
                    <p><a href={$node.url_alias|ezurl}>{'Back to poll'|i18n( 'design/eziog/collectedinfo/poll' )}</a></p>
                </div>
            </div>
