...
<p>{'Thank you for your feedback.'|i18n( 'design/eziog/collectedinfo/form' )}</p>

{if $error}

{if $error_existing_data}
<p>{'You have already submitted this form. The data you entered was:'|i18n('design/eziog/collectedinfo/form')}</p>
{/if}
...
<a href={$node.parent.url|ezurl}>{'Return to site'|i18n('design/eziog/collectedinfo/form')}</a>
