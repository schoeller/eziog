...
<div class="notification-addtonotification">
    ...
    <div class="attribute-header">
        <h1>{'Add to my notifications'|i18n( 'design/eziog/notification/addingresult')}</h1>
    </div>

    <p>
    {if $already_exists}
        {"Notification for node <%node_name> already exists."
        |i18n( 'design/eziog/notification/addingresult',,
    ...
    <form method="post" action={$redirect_url|ezurl}>
        <input class="button" type="submit" name="OK" value="{'OK'|i18n('design/eziog/notification/addingresult')}" />
    </form>
    </div>
