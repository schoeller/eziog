<div class="notification-settings">
    ...
    <div class="attribute-header">
        <h1 class="long">{'Notification settings'|i18n( 'design/eziog/notification/settings' )}</h1>
    </div>
    ...
    <input class="button" type="submit" name="Store" value="{'Apply changes'|i18n('design/eziog/notification/settings')}" />
