...
<div class="block">
    <label><input type="checkbox" name="ReceiveDigest_{$handler.id_string}" {$settings.receive_digest|choose( '', checked)} /> {'Receive all messages combined in one digest'|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}</label>
</div>

<div class="block">
<fieldset>
<legend>{'Receive digests'|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}</legend>
<table cellspacing="4">
<tr>
<td>
...
<td>
{'Daily, at'|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}
</td>
<td>
...
<td>
{'Once per week, on '|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}
</td>
<td>
...
<td>
{'Once per month, on day number'|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}
</td>
<td>
...
{'If day number is larger than the number of days within the current month, the last day of the current month will be used.'|i18n( 'design/eziog/notification/handler/ezgeneraldigest/settings/edit' )}
</fieldset>
</div>
