...
{if $direction}{* '-' direction  *}
    ...
    {if $older_event_count|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/-", $temp_offset|sum(2))|ezurl}>&lt;&lt; {"Past events"|i18n("design/eziog/full/event_view_program")}</a>
    {/if}
    </div>
    <div class="right">
    {if $temp_offset|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/-", $temp_offset)|ezurl}>{"Future events"|i18n("design/eziog/full/event_view_program")} &gt;&gt;</a>
    {elseif $newer_event_count|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/0")|ezurl}>{"Future events"|i18n("design/eziog/full/event_view_program")} &gt;&gt;</a>
    {/if}
    </div>
{else}
    <div class="left">
    {if $temp_offset|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/", $temp_offset|dec)|ezurl}>&lt;&lt; {"Past events"|i18n("design/eziog/full/event_view_program")}</a>
    {elseif $older_event_count|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/-1")|ezurl}>&lt;&lt; {"Past events"|i18n("design/eziog/full/event_view_program")}</a>
    {/if}
    </div>
    <div class="right">
    {if $newer_event_count|gt(0)}
        <a href={concat("/content/view/full/",  $node.node_id, "/offset/", $temp_offset|inc)|ezurl}>{"Future events"|i18n("design/eziog/full/event_view_program")} &gt;&gt;</a>
    {/if}
    </div>
{/if}
</div>
