...
<tr class="calendar_heading_days">
    <th class="first_col">{"Mon"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th>{"Tue"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th>{"Wed"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th>{"Thu"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th>{"Fri"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th>{"Sat"|i18n("design/eziog/full/event_view_calendar")}</th>
    <th class="last_col">{"Sun"|i18n("design/eziog/full/event_view_calendar")}</th>
</tr>
</thead>
<tbody>
...
<div id="ezagenda_calendar_today">
    {if eq($curr_ts|datetime( custom, '%j'),$temp_ts|datetime( custom, '%j'))} 
        <h2>{"Today"|i18n("design/eziog/full/event_view_calendar")}:</h2>
    {else} 
...
{foreach $day_events as $day_event}
    ...
    {"Category"|i18n("design/eziog/full/event_view_calendar")}:
...
{foreach $events as $event}
    {if and( ne($view_parameters.offset, 2), eq($loop_count, 8))}
        <a id="ezagenda_month_hidden_show" href={$url_reload|ezurl} onclick="document.getElementById('ezagenda_month_hidden').style.display='';this.style.display='none';return false;">{"Show All Events.."|i18n("design/eziog/full/event_view_calendar")}</a>
