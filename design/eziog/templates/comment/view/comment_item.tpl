...
<div class="comment">
    <div class="profile-picture">
        <img src="{'user.gif'|ezimage( 'no' )}" alt="{'Avatar'|i18n('design/eziog/comment/view')}" />
    </div>
        ...
        <div class="ezcom-comment-tool">
            {if or( $can_edit, $can_self_edit )}
                ...
                <span{$displayAttribute}>
                    <a href={concat( '/comment/edit/', $comment.id )|ezurl} class="btn btn-warning pull-right">{'Edit'|i18n('design/eziog/comment/view')}</a>
                </span>
            ...
            {if or( $can_delete, $can_self_delete )}
                ...
                <span {$displayAttribute}>
                    <a href={concat( '/comment/delete/',$comment.id )|ezurl} class="btn btn-danger">
                        {'Delete'|i18n('design/eziog/comment/view')}
                    </a>
                </span>
                {undef $displayAttribute}
            {/if}
