...
<ul>
    <li>1. {"Shopping basket"|i18n("design/eziog/shop/confirmorder")}</li>
    <li>2. {"Account information"|i18n("design/eziog/shop/confirmorder")}</li>
    <li class="selected">3. {"Confirm order"|i18n("design/eziog/shop/confirmorder")}</li>
</ul>
...
<div class="attribute-header">
    <h1 class="long">{"Confirm order"|i18n("design/eziog/shop/confirmorder")}</h1>
</div>
...
<h3>{"Product items"|i18n("design/eziog/shop/confirmorder")}</h3>
<table class="list" width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>
    {"Count"|i18n("design/eziog/shop/confirmorder")}
    </th>
    <th>
    {"VAT"|i18n("design/eziog/shop/confirmorder")}
    </th>
    <th>
    {"Price inc. VAT"|i18n("design/eziog/shop/confirmorder")}
    </th>
    <th>
    {"Discount"|i18n("design/eziog/shop/confirmorder")}
    </th>
    <th>
    {"Total price ex. VAT"|i18n("design/eziog/shop/confirmorder")}
    </th>
    <th>
    {"Total price inc. VAT"|i18n("design/eziog/shop/confirmorder")}
    </th>
</tr>
...
<tr>
<td colspan="3">
{"Selected options"|i18n("design/eziog/shop/confirmorder")}
</td>
</tr>
...
<h3>{"Order summary"|i18n("design/eziog/shop/confirmorder")}:</h3>
<table class="list" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>{"Summary"|i18n("design/eziog/shop/confirmorder")}</th>
    <th>{"Total ex. VAT"|i18n("design/eziog/shop/confirmorder")}</th>
    <th>{"Total inc. VAT"|i18n("design/eziog/shop/confirmorder")}</th>
</tr>
<tr class="bglight">
    <td>
    {"Subtotal of items"|i18n("design/eziog/shop/confirmorder")}:
    </td>
    <td>
...
<tr class="bgdark">
    <td>
    {"Order total"|i18n("design/eziog/shop/confirmorder")}:
    </td>
    <td>
...
<input class="button" type="submit" name="CancelButton" value="{'Cancel'|i18n('design/eziog/shop/confirmorder')}" /> &nbsp;
<input class="button" type="submit" name="ConfirmOrderButton" value="{'Confirm'|i18n('design/eziog/shop/confirmorder')}" /> &nbsp;
</div>
