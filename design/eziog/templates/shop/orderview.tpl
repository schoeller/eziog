...
<div class="attribute-header">
  <h1 class="long">{'Order %order_id [%order_status]'|i18n( 'design/eziog/shop/orderview',,
...
<h3>{'Product items'|i18n( 'design/eziog/shop/orderview' )}</h3>
<table class="list" width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>
    {'Product'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'Count'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'VAT'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'Price inc. VAT'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'Discount'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'Total price ex. VAT'|i18n( 'design/eziog/shop/orderview' )}
    </th>
    <th>
    {'Total price inc. VAT'|i18n( 'design/eziog/shop/orderview' )}
    </th>
</tr>
...
<h3>{'Order summary'|i18n( 'design/eziog/shop/orderview' )}:</h3>
<table class="list" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>
    {'Summary'|i18n( 'design/eziog/shop/orderview' )}:
    </th>
    <th>
    {'Total price ex. VAT'|i18n( 'design/eziog/shop/orderview' )}
    </th>
...
<tr class="bglight">
    <td>
    {'Subtotal of items'|i18n( 'design/eziog/shop/orderview' )}:
    </td>
    <td>
...
<tr class="bgdark">
    <td>
        {'Order total'|i18n( 'design/eziog/shop/orderview' )}
    </td>
    <td>
...
<h3>{'Order history'|i18n( 'design/eziog/shop/orderview' )}:</h3>
<table class="list" cellspacing="0" cellpadding="0" border="0">
<tr>
    <th>{'Date'|i18n( 'design/eziog/shop/orderview' )}</th>
    <th>{'Order status'|i18n( 'design/eziog/shop/orderview' )}</th>
</tr>
