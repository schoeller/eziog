...
<div class="attribute-header">
    <h1 class="long">{"Wish list"|i18n("design/eziog/shop/wishlist")}</h1>
</div>
...
<tr>
    <th>
    {"Product"|i18n("design/eziog/shop/wishlist")}
    </th>
    <th>
    {"Count"|i18n("design/eziog/shop/wishlist")}
    </th>
    <th>&nbsp;
...
<tr>
    ...
    <tr>
        <td colspan='3'>
        {"Selected options"|i18n("design/eziog/shop/wishlist")}
        </td>
    </tr>
...
<input class="button" type="submit" name="StoreChangesButton" value="{'Store'|i18n('design/eziog/shop/wishlist')}" />
<input class="button" type="submit" name="RemoveProductItemButton" value="{'Remove items'|i18n('design/eziog/shop/wishlist')}" />
</div>
...
<div class="feedback">
<h2>{"Empty wish list"|i18n("design/eziog/shop/wishlist")}</h2>
</div>
{/if}
</form>
