<div class="shop-customerorderview">
    <div class="attribute-header">
        <h1 class="long">{"Customer information"|i18n("design/eziog/shop/customerorderview")}</h1>
    </div>
...
<div class="attribute-header">
    <h1>{"Order list"|i18n("design/eziog/shop/customerorderview")}</h1>
</div>
...
<tr>
    <th>
    {"ID"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    {"Date"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    {"Total ex. VAT"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    {"Total inc. VAT"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    </th>
</tr>
...
<div class="attribute-header">
  <h1>{"Purchase list"|i18n("design/eziog/shop/customerorderview")}</h1>
</div>
...
<tr>
    <th>
    {"Product"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    {"Amount"|i18n("design/eziog/shop/customerorderview")}
    </th>
    <th>
    {"Total ex. VAT"|i18n("design/eziog/shop/customerorderview")}
    </th>
