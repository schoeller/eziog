...
<link rel="Home" href={"/"|ezurl} title="{'%sitetitle front page'|i18n('design/eziog/link',,hash('%sitetitle',$site.title))|wash}" />
<link rel="Index" href={"/"|ezurl} />
<link rel="Top"  href={"/"|ezurl} title="{$site_title}" />
<link rel="Search" href={"content/advancedsearch"|ezurl} title="{'Search %sitetitle'|i18n('design/eziog/link',,hash('%sitetitle',$site.title))|wash}" />
...
(function() {ldelim}
    ...
    printNode.title = "{'Printable version'|i18n('design/eziog/link')}";
