...
<div class="attribute-header">
    <h1 class="long">{'eZ Publish information: %version'|i18n('design/eziog/ezinfo/about',,hash( '%version', $ezinfo ) )|wash}</h1>
</div>
...
<div class="attribute-header">
    <h3>{'What is eZ Publish?'|i18n( 'design/eziog/ezinfo/about' )}</h3>
</div>
...
<div class="attribute-header">
    <h3>{'Licence'|i18n( 'design/eziog/ezinfo/about' )}</h3>
</div>
...
{if and( is_set( $contributors ), is_array( $contributors ), count( $contributors )|ge( 1 ) )}
    <div class="attribute-header">
        <h3>{'Contributors'|i18n( 'design/eziog/ezinfo/about' )}</h3>
    </div>
...
<div class="attribute-header">
    <h3>{'Copyright Notice'|i18n( 'design/eziog/ezinfo/about' )}</h3>
</div>
...
{if and( is_set( $third_party_software ), is_array( $third_party_software ), count( $third_party_software )|ge( 1 ) )}
    <div class="attribute-header">
        <h2>{'Third-Party Software'|i18n('design/eziog/ezinfo/about')}</h2>
    </div>
...
<div class="attribute-header">
    <h2>{'Extensions'|i18n('design/eziog/ezinfo/about')}</h2>
</div>
