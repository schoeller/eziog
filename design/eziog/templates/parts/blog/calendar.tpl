...
<div class="month">
<div class="previous">
<p><a href={$url_back|ezurl} title="{'Previous month'|i18n('design/eziog/blog/calendar')}">&#8249;&#8249;<span class="hide"> {'Previous month'|i18n('design/eziog/blog/calendar')}</span></a></p>
</div>
<div class="next">
<p><a href={$url_forward|ezurl} title="{'Next month'|i18n('design/eziog/blog/calendar')}"><span class="hide">{'Next month'|i18n('design/eziog/blog/calendar')} </span>&#8250;&#8250;</a></p>
</div>
<h2>{$temp_ts|datetime( custom, '%F' )|upfirst()}&nbsp;{$temp_year}</h2>
</div>

<table cellspacing="0" border="0" summary="{'Calendar'|i18n('design/eziog/blog/calendar')}" class="list table-colorized">
<tr class="top">
    <th class="left">{"Mon"|i18n("design/eziog/blog/calendar")}</th>
    <th>{"Tue"|i18n("design/eziog/blog/calendar")}</th>
    <th>{"Wed"|i18n("design/eziog/blog/calendar")}</th>
    <th>{"Thu"|i18n("design/eziog/blog/calendar")}</th>
    <th>{"Fri"|i18n("design/eziog/blog/calendar")}</th>
    <th>{"Sat"|i18n("design/eziog/blog/calendar")}</th>
    <th class="right">{"Sun"|i18n("design/eziog/blog/calendar")}</th>
</tr>
