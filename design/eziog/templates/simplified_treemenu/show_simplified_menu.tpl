...
{*<a class="openclose" href="#" title="{'Fold/Unfold'|i18n('design/eziog/simplified_treemenu/show_simplified_menu')}"></a>*}
{section-else}
...
{/section}
{set toolTip='Node ID: %node_id Visibility: %visibility'|i18n("design/eziog/simplified_treemenu/show_simplified_menu", , hash( '%node_id'      , $:parentNode.node.node_id, '%visibility'   , $:visibility ) ) }
{section-else}
{set toolTip=''}
{/section}
{* Text *}
