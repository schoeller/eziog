...
<div class="content-edit">
    ...
    <form enctype="multipart/form-data" method="post" action={concat( "/content/edit/", $object.id, "/", $edit_version, "/", $edit_language|not|choose( concat( $edit_language, "/" ), '' ) )|ezurl}>
        ...
        <div class="attribute-header">
            <h1 class="long">{"Edit %1 - %2"|i18n("design/eziog/edit/forum_reply",,array($class.name|wash,$object.name|wash))}</h1>
        </div>
        ...
        <div class="buttonblock">
            <input class="defaultbutton" type="submit" name="PublishButton" value="{'Send for publishing'|i18n('design/eziog/edit/forum_reply')}" />
            <input class="button" type="submit" name="DiscardButton" value="{'Discard'|i18n('design/eziog/edit/forum_reply')}" />
