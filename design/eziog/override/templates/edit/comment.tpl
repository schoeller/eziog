<div class="content-edit">
    ...
    <div class="attribute-header">
        <h1 class="long">{"Edit %1 - %2"|i18n("design/eziog/edit/comment",,array( $class.name|wash(), $object.name|wash() ) )}</h1>
    </div>
    ...
    <div class="buttonblock">
        <input class="defaultbutton" type="submit" name="PublishButton" value="{'Send for publishing'|i18n('design/eziog/edit/comment')}" />
        <input class="button" type="submit" name="DiscardButton" value="{'Discard'|i18n('design/eziog/edit/comment')}" />
