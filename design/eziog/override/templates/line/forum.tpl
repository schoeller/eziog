    ...
    <div class="class-forum">
        <table class="list forum" cellspacing="0">
            <tr>
                ...
                <th class="topic"> {"Number of topics"|i18n("design/eziog/line/forum")} </th>
                <th class="replies"> {"Number of posts"|i18n("design/eziog/line/forum")} </th>
                <th class="lastreply"> {"Last reply"|i18n( "design/eziog/line/forum" )} </th>
            </tr>
            <tr>
                <td><h2><a href={$node.url_alias|ezurl}>{$node.name|wash}</a></h2>
                    ...
                    <div class="attribute-link">
                        <p><a href={$node.url_alias|ezurl}>{"Enter forum"|i18n("design/eziog/line/forum")}</a></p>
                    </div></td>
