        ...
        <div class="span8">
           ...
           {if $related_purchase}
            <div class="relatedorders">
                <h2>{'People who bought this also bought'|i18n( 'design/eziog/full/product' )}</h2>
                            ...
                            <form method="post" action={"content/action"|ezurl}>
                                <fieldset class="row">
                                    ...
                                    <div class="item-buying-action form-inline span4">
                                        <label>
                                            <span class="hidden">{'Amount'|i18n("design/eziog/full/product")}</span>
                                            <input type="text" name="Quantity" />
                                        </label>
                                        <button class="btn btn-warning" type="submit" name="ActionAddToBasket">
                                        {'Add to basket'|i18n("design/eziog/full/product")}
                                        </button>
                                    </div>
                                </fieldset>
