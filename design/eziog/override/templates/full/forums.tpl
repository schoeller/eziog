...
<div class="content-view-full">
    <div class="class-forums">
        ...
        <table class="list forum" cellspacing="0">
            <tr>
                <th>{"Forum"|i18n( "design/eziog/full/forums" )}</th>
                <th class="topic">{"Topics"|i18n( "design/eziog/full/forums" )}</th>
                <th class="replies">{"Posts"|i18n( "design/eziog/full/forums" )}</th>
                <th class="lastreply">{"Last reply"|i18n( "design/eziog/full/forums" )}</th>
            </tr>
