...
<div class="content-view-full">
    <div class="class-article-mainpage">
        ...
        <div class="attribute-tipafriend">
            <p><a href={concat( "/content/tipafriend/", $node.parent.node_id )|ezurl} title="{'Tip a friend'|i18n( 'design/eziog/full/article_subpage' )}">{'Tip a friend'|i18n( 'design/eziog/full/article_subpage' )}</a></p>
        </div>
        {/if}
