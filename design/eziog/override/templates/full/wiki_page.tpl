...
<div class="content-view-full">
    <div class="class-documentation-page">
        ...
        <div class="attribute-toc">
            <h2>{'Table of contents'|i18n( 'design/eziog/full/wiki_page' )}</h2>
        ...
        <div class="attribute-byline">
            <p class="published">{'Created:'|i18n( 'design/eziog/full/wiki_page' )} {$node.object.published|l10n(shortdatetime)}</p>
            <p class="modified">{'Modified:'|i18n( 'design/eziog/full/wiki_page' )} {$node.object.modified|l10n(shortdatetime)}</p>
        </div>
