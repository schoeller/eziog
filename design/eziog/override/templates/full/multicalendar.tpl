...
<div class="content-view-full">
    <div class="class-multicalendar">
       ...
       {foreach $node.data_map.calendars.content.relation_list as $relation}
            ...
            <tr>
                <th>{'Event'|i18n( 'design/eziog/full/multicalendar' )}</th>
                <th>{'Start date'|i18n( 'design/eziog/full/multicalendar' )}</th>
                <th>{'Category'|i18n( 'design/eziog/full/multicalendar' )}</th>
                <th>{'Description'|i18n( 'design/eziog/full/multicalendar' )}</th>
            </tr>
