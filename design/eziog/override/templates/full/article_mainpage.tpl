...
<div class="content-view-full">
    ...
    {if and( ezmodule( 'content/tipafriend' ), $tipafriend_access )}
        <div class="attribute-tipafriend">
            <p><a href={concat( "/content/tipafriend/", $node.node_id )|ezurl} title="{'Tip a friend'|i18n( 'design/eziog/full/article_mainpage' )}">{'Tip a friend'|i18n( 'design/eziog/full/article_mainpage' )}</a></p>
        </div>
    {/if}
