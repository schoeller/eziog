{set-block scope=root variable=subject}{"Collected information from %1"|i18n("design/eziog/colledtedinfomail",,array($collection.object.name|wash))}{/set-block}
...
{"The following information was collected"|i18n("design/eziog/colledtedinfomail")}:
